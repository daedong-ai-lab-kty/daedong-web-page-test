...
LOCAL_SEARCH_SYSTEM_PROMPT_REF = """
...
(3) 답변의 마지막에는 참조한 정보의 출처 파일명을 [파일명.txt] 형식으로 반드시 표기해야 합니다. 출처는 가장 유사도가 높은 순서대로 최대 3개까지만 표기하고, 쉼표로 구분하여 [파일1.txt], [파일2.txt]와 같이 나열해주세요.
---제약 조건---
