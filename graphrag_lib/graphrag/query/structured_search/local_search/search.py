...
from .na_system_prompt import (
    NA_LOCAL_SEARCH_SYSTEM_PROMPT,
)
from ..constraints.language_prompt import (
    LANGUAGE_PROMPT,
)
from ..constraints.role_prompt import (
    ROLE_PROMPT,
)
        ...
        **kwargs,
        ...
        try:
            search_prompt = self.system_prompt.format(
                context_data=context_text, response_type=self.response_type, language=language
            )
            # reporter.info(f"System prompt: {search_prompt}")
